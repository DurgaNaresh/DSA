 ...
 * Involutory matrix is the matrix that is its own inverse. The matrix A is said to be involutory matrix if A * A = I.
 ...
 * @author DurganNaresh
 */
public class Program_Check_Involutory_Matrix {
    static int N = 3;
