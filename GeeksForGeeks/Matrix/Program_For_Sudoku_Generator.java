 ...
 * @author DurganNaresh
 */
public class Program_For_Sudoku_Generator {
    int[] mat[];
    ...
    // Constructor
    Program_For_Sudoku_Generator(int N, int K)
    {
        this.N = N;
        this.K = K;
    ...
    {
        int N = 9, K = 20;
        Program_For_Sudoku_Generator sudoku = new Program_For_Sudoku_Generator(N, K);
        sudoku.fillValues();
        sudoku.printSudoku();
    }
}
