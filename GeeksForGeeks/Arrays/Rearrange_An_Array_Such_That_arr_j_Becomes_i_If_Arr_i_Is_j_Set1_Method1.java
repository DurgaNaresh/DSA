...
/**
 * created 20/04/2021 - 12:25 PM
 *
 * @author DurganNaresh
 */
public class Rearrange_An_Array_Such_That_arr_j_Becomes_i_If_Arr_i_Is_j_Set1_Method1 {
    ...
    {
        Rearrange_An_Array_Such_That_arr_j_Becomes_i_If_Arr_i_Is_j_Set1_Method1 arrange = new Rearrange_An_Array_Such_That_arr_j_Becomes_i_If_Arr_i_Is_j_Set1_Method1();
        int arr[] = { 2, 0, 1, 4, 5, 3 };
        int n = arr.length;
