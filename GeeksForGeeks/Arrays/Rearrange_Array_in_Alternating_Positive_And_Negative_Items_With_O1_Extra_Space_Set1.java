...
/**
 * created 20/04/2021 - 11:09 AM
 *
 * @author DurganNaresh
 */
public class Rearrange_Array_in_Alternating_Positive_And_Negative_Items_With_O1_Extra_Space_Set1 {
    ...
    {
        Rearrange_Array_in_Alternating_Positive_And_Negative_Items_With_O1_Extra_Space_Set1 rearrange = new Rearrange_Array_in_Alternating_Positive_And_Negative_Items_With_O1_Extra_Space_Set1();
        /* int arr[n] = {-5, 3, 4, 5, -6,
                         -2, 8, 9, -1, -4};
        int arr[] = {-5, -3, -4, -5, -6,
                     2 , 8, 9, 1 , 4};
