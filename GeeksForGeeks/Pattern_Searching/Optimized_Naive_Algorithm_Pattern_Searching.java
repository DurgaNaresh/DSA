package com.durga.Geek_For_Geeks.Pattern_Searching;

/**
 * created 21/04/2021 - 8:29 PM
 *
 * @author DurganNaresh
 ...
 * we know that the first character of pattern will not match the j matched characters because
 * all characters of pattern are different. So we can always slide the pattern by j
 * without missing any valid shifts. Following is the modified code that is optimized
 * for the special patterns.
 */
public class Optimized_Naive_Algorithm_Pattern_Searching {
