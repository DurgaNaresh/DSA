<h2><a href="https://practice.geeksforgeeks.org/problems/average4856/1?page=1&difficulty=School&status=unsolved&sortBy=accuracy">Average in a stream</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a stream of incoming numbers, find average or mean of the stream at every point.</span></p>
