<h2><a href="https://www.geeksforgeeks.org/problems/while-loop-printtable-java/1">While loop- printTable - Java</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><em><span style="font-size:18px">While loop is another loop like for loop but unlike for loop it only checks for one condition.</span></em></p>
